...
| [docs/MULTI-TENANT.md](docs/MULTI-TENANT.md) | **Exploratory, not built** — running the system for other server operators; why in-mod shops were rejected, and the auth/data changes tenancy needs |
